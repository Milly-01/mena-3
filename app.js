...
app.use(cors({
    credentials: true,
    origin: ["https://mena-e-commerce-3.onrender.com"]
}));


mongoose.connect(process.env.MONGOATLASSURL, {})
...
// Request to get food
app.post("/api/getfood", function(req, res){
...
app.get("/api/getfood", function(req, res){
    res.sendFile(__dirname+"/build/index.html")
});
